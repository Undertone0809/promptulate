...
from pne.output_formatter.prompt import OUTPUT_FORMAT
...
def get_formatted_instructions(
    ...
    if examples:
        ...
        for example in examples:
            example_str = json.dumps(example.model_dump())
...
def formatting_result(pydantic_obj: type(BaseModel), llm_output: str) -> T:
    ...
    try:
        ...
        raise f"Failed to parse {name} from completion {llm_output}. Got: {e}"
