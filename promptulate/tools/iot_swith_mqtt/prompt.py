...
PROMPT_TEMPLATE = """
Now you are an intelligent voice assistant, and the user will input "{question}" to you.
...
If none of them match, please indicate that you couldn't identify the user's intent and provide a reason, 
