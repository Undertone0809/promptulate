...
from promptulate.preset_roles.prompt import (
    PRESET_SYSTEM_PROMPT,
    PRESET_SYSTEM_PROMPT_COMPLETION_ZH,
)
...
class OpenAI(BaseLLM):
    ...
    def __call__(
        ...
        preset = (
            ...
            else PRESET_SYSTEM_PROMPT_COMPLETION_ZH
        )

        return self.generate_prompt(preset + prompt).content

    def generate_prompt(
        self, prompts: str, stop: Optional[List[str]] = None
    ...
    def api_key(self):
        ...
        return CFG.get_openai_api_key("gpt-3.5-turbo")
