...
class Core(object):
    ...
    def add_member_into_chatroom(
        self, chatroomUserName, memberList, useInvitation=False
    ):
    ...
    def msg_register(
        self, msgType, isFriendChat=False, isGroupChat=False, isMpChat=False
    ):
    ...
    def search_friends(
        ...
        return self.storageClass.search_friends(
            name, userName, remarkName, nickName, wechatAccount
        )
