...
class AIChat:
    def __init__(
        ...
        Args:
            ...
            mode(Mode): chat mode, default is Mode.CHAT.
        """
    ...
    # Basic scenario - no tools, no streaming
    @overload
    def run(
        self,
        ...
        examples: None = None,
        return_raw_response: Literal[False] = False,
    ...
    def run(
        ...
        output_schema: None = None,
        examples: None = None,
        return_raw_response: Literal[True] = True,
        stream: Literal[False] = False,
        **kwargs,
    ) -> AssistantMessage: ...

    # Output schema scenario
    @overload
    def run(
        self,
        messages: Union[List[Dict[str, str]], MessageSet, str],
    ...
    # Non-streaming tool scenario - basic return
    @overload
    def run(
        self,
        messages: Union[List[Dict[str, str]], MessageSet, str],
    ...
    # Non-streaming tool scenario - with output schema
    @overload
    def run(
        self,
        messages: Union[List[Dict[str, str]], MessageSet, str],
...
# Tool with output mode scenario
@overload
def chat(
    messages: Union[List, MessageSet, str],
    *,
